...
#include "string/replace/test_replace.h"
#include "string/index_of/test_index_of.h"
#include "string/destroy/test_destroy.h"

#include "string/string_length/test_string_length.h"
#include "string/string_copy/test_string_copy.h"
#include "string/string_ncopy/test_string_ncopy.h"
...
int main (const int argc, const char** argv)
{
    ...
    run_string_length_suite();
    run_string_copy_suite();
    run_string_ncopy_suite();
